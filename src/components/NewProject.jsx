...
export default function NewProject(){
    return (<div className="w-[35rem] mt-16" >
        <fieldset className="flex items-center justify-end gap-4 my-4" >
            <button className="cursor-pointer bg-teal-600 text-[#EFE9D5] px-6 py-2    active:text-[#d3cebe]  rounded-md shadow-lg transition-all duration-150 active:scale-90 active:shadow-md " >Cancel</button>
